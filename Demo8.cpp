...
// cl Demo8.cpp Strings.cpp /O1 /Os /GS- TCLib.lib kernel32.lib user32.lib
// cl Demo8.cpp Strings.cpp /O1 /Os /GS- /Zc:sizedDealloc- /link TCLib.lib kernel32.lib user32.lib
